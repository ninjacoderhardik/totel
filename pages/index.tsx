...
const RLookingForPartnerSearch: NextPage = () => {
  return (
    <div className="relative bg-base-white w-full h-[553.94rem] overflow-hidden text-left text-[0.88rem] text-gray-700 font-text-l-semibold">
      <div className="absolute top-[0rem] left-[-0.06rem] flex flex-col items-start justify-start gap-[2.5rem]">
        <div className="flex flex-col items-start justify-start gap-[1.5rem]">
          <div className="flex flex-col items-start justify-start">
            <div className="overflow-hidden flex flex-col items-start justify-start gap-[2.5rem]">
              <div className="flex flex-col items-start justify-start">
                <div className="w-[22.5rem] flex flex-col items-start justify-start">
                  <div className="w-[22.5rem] flex flex-row py-[0.63rem] px-[1.25rem] box-border items-center justify-between">
                  ...
                  <div className="relative w-[22.56rem] h-[27.38rem]">
                    <img
                      className="absolute top-[0rem] left-[0.06rem] w-[22.56rem] h-[27.38rem] object-cover"
                      alt=""
                      src="/frame-1@2x.png"
                    />
                      ...
                      <div className="flex flex-col items-start justify-start gap-[1.88rem]">
                        <div className="rounded-xl flex flex-row items-start justify-start">
                          <div className="flex flex-col items-center justify-start gap-[0.63rem]">
                            <div className="relative w-[17.94rem] h-[4.75rem] overflow-hidden shrink-0">
                              ...
                              <div className="absolute top-[1.75rem] left-[0.03rem] rounded-81xl w-[17.81rem] flex flex-col items-start justify-center gap-[0.25rem]">
                                ...
                                <div className="self-stretch rounded-81xl bg-base-white flex flex-row py-[0.75rem] px-[1.25rem] items-center justify-start gap-[0.75rem] text-[0.75rem] border-[1px] border-solid border-neutral-700">
                                  <img
              ...
              <div className="flex flex-col py-[0rem] pr-[0rem] pl-[1.25rem] items-start justify-start text-[0.75rem]">
                <div className="flex flex-col items-center justify-start">
                  <div className="flex flex-row items-center justify-center gap-[0.44rem]">
                    <div className="flex flex-row items-center justify-center">
                      <div className="rounded-81xl bg-base-white shadow-[0px_1px_2px_rgba(16,_24,_40,_0.04)] overflow-hidden flex flex-row py-[0.31rem] px-[0.63rem] items-center justify-center gap-[0.38rem] border-[1px] border-solid border-neutral-700">
                        <img
                    ...
                    <div className="flex flex-row items-start justify-start gap-[0.5rem]">
                      <div className="rounded-81xl bg-base-white shadow-[0px_1px_2px_rgba(16,_24,_40,_0.04)] overflow-hidden flex flex-row py-[0.31rem] px-[0.75rem] items-center justify-center gap-[0.38rem] border-[1px] border-solid border-neutral-700">
                        <img
                          className="relative w-[1.25rem] h-[1.25rem] overflow-hidden shrink-0 hidden"
                          alt=""
                          src="/filter.svg"
          ...
          <div className="w-[22.5rem] flex flex-col items-center justify-start gap-[1rem] text-[1.25rem] text-base-black">
        ...
        <div className="flex flex-col items-start justify-start text-center text-base-white">
          <div className="bg-purple-secondary-600 w-[22.56rem] flex flex-col py-[4rem] px-[0rem] box-border items-center justify-center">
...
export default RLookingForPartnerSearch;
